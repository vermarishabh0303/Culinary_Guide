...
function StatsSection() {
  return (
    <section className="flex justify-center bg-gray-900">
      <div className="flex flex-col md:flex-row items-center gap-6 md:gap-0 md:justify-around pt-6 md:pt-8 pb-14 md:pb-16 w-full max-w-[1400px] text-center px-6">
